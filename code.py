#YouTube Comment Analysis code in Python using YouTube API
...
if __name__ == "__main__":
 ...
 help="Required; ID for video for which the comment will be 
inserted.")
...
time.sleep(1)
print(" ==> PERCENTAGE OF COMMENTS THAT ARE POSITIVE : 
",positive_percentage,"%\n")
time.sleep(1)
print(" ==> PERCENTAGE OF COMMENTS THAT ARE NEGATIVE : 
",negative_percentage,"%\n")
time.sleep(1)
print(" ==> PERCENTAGE OF COMMENTS THAT ARE NEUTRAL : 
",neutral_percentage,"%\n")
time.sleep(1)
